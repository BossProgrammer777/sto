...
FALLBACK_VALIDATION: dict[str, list[str]] = {
    ...
    # Резерв на случай недоступности чтения. Основной источник — выпадающий
    # список колонки «МОП Запись» в таблице (бот читает его сам).
    "mop": [
        "Симоненко Сергей", "Александров Егор", "Рябцев Александр", "Ольховский Олег",
        "Шабатько Вячеслав", "Борисов Дмитрий", "Шевченко Владислав", "Симоненко Алекс",
        "Давыдов Александр", "Скороход Артём", "Кучерявый Александр", "Белоглазов Дмитрий",
        "Майданец Сергей", "Татара Денис", "Садурский Виталий", "Кваша Татьяна",
        "Сюта Виталий", "Нестеренко Вячеслав",
    ],
}
